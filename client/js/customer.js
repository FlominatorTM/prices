...
$(window).load(function () {
    ...
    function viewModel(items) {
        ...
        self.addItem = function () {
			self.newItem = true;
            self.items.push(new customer({ firstname: "", lastname: "" }));
	...
	var initialData = [
			{ id: "1", firstname: "Max", lastname: "Mustermann", street: "Musterstrasse 1", city: "Musterstadt",
				phones: [
			...
			{ id: "2", firstname: "Paula", lastname: "Musterfrau", street: "Reeperbahn 12", city: "Hamburg",
				phones: [
				{ type: "Office", number: "" },
			...
			{ id: "3", firstname: "Heinz", lastname: "Wagner", street: "", city: "Hannover",
				phones: [
			...
			{ id: "4", firstname: "Hannes", lastname: "Meier", street: "Seestr. 12", city: "",
				phones: [
				{ type: "Office", number: "" },
				{ type: "Home", number: "" },
				{ type: "Mobile", number: ""}],
			...
			{ id: "5", firstname: "Andrea", lastname: "Lindenberg", street: "Alster 15", city: "Hamburg",
				phones: [
	...
	// ko.applyBindings(new viewModel([
		...
		// { firstname: "Paula", lastname: "Tanne" }
		// ]));
